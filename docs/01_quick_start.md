...
4. Dump the useful modding artifacts from your local game install:
...
6. Generate the local editor project:
...
6. `docs/03_ue4ss_and_runtime.md`
7. `docs/04_editor_project_and_jmap.md`
8. `docs/05_dumps_sdk_assets.md`
9. `docs/06_tooling_reference.md`
10. `docs/07_jmap_static_mirror_learnings.md`
